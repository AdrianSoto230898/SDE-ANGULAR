...
@Component({
    selector: 'app-custom-select-search-value',
    imports: [CommonModule, FormsModule],
    templateUrl: './custom-select-search-value.component.html',
    providers: [
        {
            provide: NG_VALUE_ACCESSOR,
            useExisting: forwardRef(() => CustomSelectSearchValueComponent),
            multi: true
        }
    ]
})

export class CustomSelectSearchValueComponent {
